...
from config import CSV_EMPLOYEES, CSV_CONTRACTS, CSV_PAYROLL, CSV_PAYSLIPS, CSV_FNF, CURRENT_FY
from services.csv_service import read_csv, read_csv_filtered
from services.contract_service import get_active_contract
from services.payslip_service import get_employee_payslips
...
def get_employee_dashboard_metrics(employee_id: str) -> dict:
    ...
    from config import CSV_EMPLOYEE_SALARY
