...
def execute_completed_action(module: str, record_id: str):
    ...
    if module == "Contracts":
        # Approve contract
        from services.contract_service import update_contract_status
        ...
        from services.fnf_service import update_settlement_status
        # update_settlement_status(record_id, "Approved", "System")
        pass
    elif module == "Investment Proofs":
        # Verify proof
        from services.proof_service import approve_proof
