"""
app/main.py – Application entry point for the Employee Taxation Prototype.
...
# Ensure taxation_prototype/ is on sys.path when running as module
_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
if _ROOT not in sys.path:
    sys.path.insert(0, _ROOT)

from jinja2 import ChoiceLoader, FileSystemLoader
from flask import Flask, render_template, session, redirect, url_for, request, flash, send_from_directory, abort
...
app = Flask(
    __name__,
    static_folder=os.path.join(_APP_DIR, "base", "static"),
...
app.jinja_loader = ChoiceLoader([FileSystemLoader(d) for d in _template_dirs])
