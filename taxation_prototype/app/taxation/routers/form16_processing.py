...
from app.taxation.services.form16_processing_service import (
    validate_tan,
...
def download_signed(filename):
    ...
    """
    from app.base.utils.config import FORM16_SIGNED_FOLDER, FORM16_MERGED_FOLDER
...
def check_certificate():
    from app.taxation.services.sign_service import has_certificate
...
def sign_form16():
    ...
    """
    from app.taxation.services.sign_service import sign_pdf
    from app.base.utils.config import FORM16_MERGED_FOLDER, FORM16_SIGNED_FOLDER
