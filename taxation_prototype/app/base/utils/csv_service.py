...
def get_all_employees() -> list[dict]:
    ...
    from app.base.utils.config import CSV_EMPLOYEES
...
def is_declaration_window_open(fy: str) -> bool:
    from app.base.utils.config import CSV_DECLARATION_WINDOWS
...
def create_declaration(emp_id: str, fy: str, regime: str, items: dict, status: str) -> str:
    ...
    from app.base.utils.config import CSV_DECLARATIONS, CSV_DECLARATION_ITEMS
...
def get_declaration_items(decl_id: str) -> dict:
    from app.base.utils.config import CSV_DECLARATION_ITEMS
