"""Application startup: directory bootstrap, CSV init, and data seeding."""
import json
import os
import uuid
...
from app.base.utils.config import (
    UPLOAD_FOLDER, GENERATED_FOLDER, FORM16_FOLDER, FORM24Q_FOLDER, DUMMY_DATA_FOLDER,
    CSI_FOLDER, FORM16_PROCESSING_FOLDER, FORM16_MERGED_FOLDER, FORM16_SIGNED_FOLDER,
    CSV_EMPLOYEES, CSV_DECLARATIONS, CSV_DECLARATION_ITEMS, CSV_PROOFS, CSV_PAYROLL,
    CSV_EMPLOYEE_SALARY, CSV_TDS, CSV_DECLARATION_WINDOWS, CSV_FORM16, CSV_FORM16_HISTORY,
    CSV_FORM24Q_HISTORY, CSV_CHALLANS, CSV_DEDUCTOR_MASTER, CSV_FORM16_PROCESSING_LOG,
    CSV_CONTRACTS, CSV_SALARY_COMPONENTS, CSV_SALARY_STRUCTURES, CSV_STRUCTURE_COMPONENTS,
    CSV_PAYROLL_BATCHES, CSV_STATUTORY_CONFIG, CSV_PAYSLIPS, CSV_FNF,
)
from app.base.utils.csv_service import ensure_csv
...
def run_startup() -> None:
    ...
    from app.base.utils.config import CSV_FORM24Q_HISTORY
